  ...
  <div class="card-color">
    <div class="card-header">
      <div class="d-flex justify-content-between">
        ...
        <span class="border-bottom text-white">{{$second_medical_case->created_at}}</span>
      </div>
    </div>
    <div class="card-header">
      <div class="d-flex justify-content-between">
        <span class="font-weight-bold text-white">Updated At: </span>
        <span class="border-bottom text-white">{{$second_medical_case->created_at}}</span> </div>
      </div>
    <div class="card-header">
      <div class="d-flex justify-content-between">
    ...
    <div class="card-header ">
        <div class="d-flex justify-content-between">
          ...
          <span class="border-bottom text-white">{{$second_medical_case->local_medical_case_id}}</span>
        </div>
      </div>
  </div>
</div>
