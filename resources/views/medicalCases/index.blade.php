      ...
      <div class="card">
        <div class="card-header d-flex ">
          ...
          <div class="ml-auto p-2">
            {{-- <a href="{{route('medical-cases.medicalCaseIntoCsv')}}" class="btn btn-outline-dark">Export Csv</a>
            <a href="{{route('medical-cases.medicalCaseIntoExcel')}}" class="btn btn-outline-dark"> Export Excel</a> --}}
